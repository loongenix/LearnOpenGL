//
// Created by jijiachun on 2019/2/15.
//
#include <glad/glad.h>
#include "Hello3D.h"
...
void Hello3D::init() {
    ...
    ourShader.Load("res/shader/hello3DVertex.glsl", "res/textureFragment.glsl");
    ...
    */
    ...
    ourShader.setMatrix4fv("projection", &projection[0][0]);

    /*   glm::mat4 view;
   // 注意，我们将矩阵向我们要进行移动场景的反方向移动。
       view = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
       ourShader.setMatrix4fv("view", &view[0][0]);*/
}
...
void Hello3D::draw() {
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        float angle = 20.0f * i;
        auto radian = glm::radians(angle);
        if (i % 3 == 0) {
            radian *= glfwGetTime();
        }
        model = glm::rotate(model, radian, glm::vec3(1.0f, 0.3f, 0.5f));
        ourShader.setMatrix4fv("model", &model[0][0]);

        glDrawArrays(GL_TRIANGLES, 0, 36);
    }
}

void Hello3D::destroy() {
